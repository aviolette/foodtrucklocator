...
<form action="" method="POST">
  ...
  <div class="clearfix">
    ...
    <div class="input">
      <input type="text" id="matchOnlyIf" name="matchOnlyIf" value="${truck.matchOnlyIf}"/>
    </div>
  </div>
  <div class="clearfix">
    ...
    <div class="input">
      <ul class="inputs-list">
        <li><label><input type="checkbox" name="options" value=""/> <span>Use twittalyzer</span></label></li>
        <li><label><input type="checkbox" name="options" value=""/> <span>Inactive</span></label></li>
      </ul>
    </div>
  </div>
