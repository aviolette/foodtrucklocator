...
<div class="row">
  <div class="col-lg-12">
    ...
    <p>The ideal way to put your truck on my website is a combination of a tracking device + advanced schedules
      specified in the vendor portal or a published calendar.</p>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-lg-3">
    ...
    <p>
      ...
      the
      location and time information and put them on my website. I have always considered this a stop-gap solution, and
      not an accurate way to put your truck on my website.
    </p>
  </div>
</div>
