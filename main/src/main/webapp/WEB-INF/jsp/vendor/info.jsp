...
<div class="row">
  <div class="col-lg-12">
    <h1>How to Publish Your Location on this Site</h1>
  </div>
</div>
...
<div class="row">
  <div class="col-lg-3">
    ...
    <p>I sell a tracking device that can be plugged into your truck's OBD port or wired into your ignition. Once you
      ...
      and
      send out alerts to your customers via social media. Contact me at 847-863-4992 if you'd like more information on
      this.</p>
  </div>
  <div class="col-lg-3">
