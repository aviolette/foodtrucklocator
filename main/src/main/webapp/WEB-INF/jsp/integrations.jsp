...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="media">
      <a class="mr-4 app-icon" href="https://slack.com/oauth/authorize?client_id=438175788853.466163281394&state=${slackCode}&redirect_uri=${encodedSlackUrl}&scope=incoming-webhook,chat:write:bot,links:write,channels:read"><img alt="Add to Slack" height="40" width="139" src="https://platform.slack-edge.com/img/add_to_slack.png" srcset="https://platform.slack-edge.com/img/add_to_slack.png 1x, https://platform.slack-edge.com/img/add_to_slack@2x.png 2x" /></a>
      <div class="media-body">
