 ...
 * @since 2018-12-27
 */
public class PlankRoadTapRoomReaderTest {

  private PlankRoadTapRoomReader reader;

  @Before
  public void setup() {
    reader = new PlankRoadTapRoomReader(ZoneId.of("America/Chicago"));
  }

  @Test
  public void findStops() throws IOException {
    InputStream str = ClassLoader.getSystemClassLoader()
        .getResourceAsStream("plankroad.html");
